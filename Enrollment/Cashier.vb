...
Public Class Cashier
    ...
    Private Sub btn_dash_Click(sender As Object, e As EventArgs) Handles btn_dash.Click
        ...
        Dim dash As New DashboardCashier
        OpenForm(New DashboardCashier)
    End Sub

    Private Sub btn_pay_Click(sender As Object, e As EventArgs) Handles btn_pay.Click
        ActivateButton(sender, Color.LightBlue)
        Dim dash As New Payment

        OpenForm(New Payment)
    End Sub

    Private Sub btn_bal_Click(sender As Object, e As EventArgs) Handles btn_bal.Click
        ActivateButton(sender, Color.LightBlue)
        Dim dash As New Balance
        OpenForm(New Balance)
    End Sub

    Private Sub btn_about_Click(sender As Object, e As EventArgs) Handles btn_about.Click
        ActivateButton(sender, Color.LightBlue)
        Dim dash As New About
        OpenForm(New About)
    End Sub
